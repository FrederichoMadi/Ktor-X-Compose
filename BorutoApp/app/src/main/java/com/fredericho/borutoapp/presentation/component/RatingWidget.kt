package com.fredericho.borutoapp.presentation.component
...
import com.fredericho.borutoapp.ui.theme.EXTRA_SMALL_PADDING
import com.fredericho.borutoapp.ui.theme.LightGray
import com.fredericho.borutoapp.ui.theme.StarColor
...
fun RatingWidget(
    ...
    val starPath = remember {
        androidx.compose.ui.graphics.vector.PathParser().parsePathString(startPathString).toPath()
    }
...
fun HalfFilledStar(
    ...
    Canvas(modifier = Modifier.size(24.dp)) {
        ...
        scale(scale = scaleFactor) {
            ...
            val left = (canvasSize.width / 2f) - (pathWidth / 2f)
            val top = (canvasSize.height / 2f) - (pathHeight / 2f)
